...
for log_name in LOG_NAME_ARRAY:
    template_dict = {}
    template_dict["template_file_path"] = (
        "examples/TEMPLATE_Event_Logs_Retain-LOG-Windows.bes"
    )
...
sha256:6ffb6416366652993c992280e29faea3507b5b5aa661c33ba1af31f48acea9c4"
    ...
    print(
        generate_bes_from_template.generate_bes_from_template(template_dict)
